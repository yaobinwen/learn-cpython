...
class AlterFunction(unittest.TestCase):
    ...
    # decorated function.
    @mock.patch(
        target="A.say_hi", new=_altered_say_hi  # Altered version of the target.
    )
...
class AlterFunction2(unittest.TestCase):
    ...
    @mock.patch(
        target="A.say_goodbye", new=mock.MagicMock(return_value=-1), create=True
    )
...
class AlterModule(unittest.TestCase):
    ...
    def test_alter_A_2(self):
        ...
        with mock.patch(
            target="__main__.A.say_goodbye", new=_say_goodbye, create=True
        ) as m:
        ...
        try:
            ...
            with mock.patch(
                target="__main__.A.say_goodbye", new=_say_goodbye, create=False
            ):
